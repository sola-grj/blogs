import{_ as l}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as i,a as n,e as s,d as a,o as t}from"./app-Ba2CBXJF.js";const d={};function u(r,e){return t(),i("div",null,e[0]||(e[0]=[n("h1",{id:"typescript",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#typescript"},[n("span",null,"TypeScript")])],-1),n("h2",{id:"typescript中的基本类型",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#typescript中的基本类型"},[n("span",null,[n("strong",null,"TypeScript中的基本类型")])])],-1),n("p",null,"TypeScript中的基本类型：",-1),n("ul",null,[n("li",null,[n("p",null,"类型声明"),n("ul",null,[n("li",null,[n("p",null,"类型声明是TS非常重要的一个特点；")]),n("li",null,[n("p",null,"通过类型声明可以指定TS中变量（参数、形参）的类型；")]),n("li",null,[n("p",null,"指定类型后，当为变量赋值时，TS编译器会自动检查值是否符合类型声明，符合则赋值，否则报错；")]),n("li",null,[n("p",null,"简而言之，类型声明给变量设置了类型，使得变量只能存储某种类型的值；")]),n("li",null,[n("p",null,"语法："),n("ul",null,[n("li",null,[n("div",{class:"language-text line-numbers-mode","data-ext":"text","data-title":"text"},[n("pre",{class:"language-text"},[n("code",null,`let 变量: 类型;
